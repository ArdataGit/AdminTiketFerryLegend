...
<div class="dashboard-content">
    <h2 class="mb-4">Master Routes</h2>
    <div class="d-flex justify-content-between mb-3">
        <h5>List Routes</h5>
    </div>
    <div class="row mb-3">
        <div class="col-6">
            <input type="text" id="searchInput" class="form-control" placeholder="Search routes..." style="max-width: 300px;">
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('searchInput').addEventListener('input', function() {
        ...
        searchTimeout = setTimeout(() => {
            ...
            refreshTable(routesData, searchTerm);
        }, 300); // Debounce to prevent excessive filtering
    });

    // Initial table render
    refreshTable(routesData);
});
</script>
@endsection