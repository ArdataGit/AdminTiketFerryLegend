<?php $__env->startSection('title', 'Master Schedule'); ?>
...
<div class="dashboard-content">
    ...
    <div class="card mb-4 shadow-sm">
        <div class="card-body bg-light">
            <form id="searchScheduleForm" method="GET" action="<?php echo e(route('schedule.index')); ?>" class="row g-3 align-items-center">
                <div class="col-md-3">
                    <label for="departure_date" class="form-label mb-0">Departure Date</label>
                    <input type="date" class="form-control" id="departure_date" name="departure_date" 
                           value="<?php echo e($request->input('departure_date', date('Y-m-d'))); ?>" required>
                </div>
                <div class="col-md-3">
                    ...
                    <select class="form-select" id="stop_from_id" name="stop_from_id" required>
                        ...
                        <?php $__currentLoopData = $stops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($stop['id']); ?>" <?php echo e($request->input('stop_from_id') == $stop['id'] ? 'selected' : ''); ?>>
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-select" id="stop_to_id" name="stop_to_id" required>
                        <option value="">-- Select Stop --</option>
                        <?php $__currentLoopData = $stops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($stop['id']); ?>" <?php echo e($request->input('stop_to_id') == $stop['id'] ? 'selected' : ''); ?>>
                                <?php echo e($stop['name']); ?>
                ...
                <div class="col-md-3 d-flex align-items-end mt-4">
                    ...
                    <?php if($request->has('departure_date')): ?>
                        <a href="<?php echo e(route('schedule.index')); ?>" class="btn btn-secondary ms-2">Reset</a>
                    <?php endif; ?>
                </div>
            </form>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    // API configuration
    const apiBase = '<?php echo e(config('services.api.base')); ?>';
    const apiKey = '<?php echo e($apiKey); ?>';
    const endpoint = `${apiBase}/vehicle.booking.schedule/search_schedule`;

    // Initial data from controller
    let initialData = {
        records: <?php echo json_encode($schedule, 15, 512) ?>,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template.admin-dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\AdminTiketFerryLegend\resources\views/admin/admin-schedule.blade.php ENDPATH**/ ?>