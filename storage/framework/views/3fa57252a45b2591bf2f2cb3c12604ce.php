...
<div class="dashboard-content">
    ...
    <a href="<?php echo e(url('dashboard/bookings')); ?>" class="btn btn-secondary mt-3">Back to List</a>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let initialData = {
        records: <?php echo json_encode($details, 15, 512) ?>,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template.admin-dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\AdminTiketFerryLegend\resources\views/admin/admin-booking-details.blade.php ENDPATH**/ ?>