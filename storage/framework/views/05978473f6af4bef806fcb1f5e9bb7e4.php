...
let allRecords = <?php echo json_encode($bookings, 15, 512) ?> || [];
let currentPage = 1;
let perPage = 10;
...
function renderTable(search='') {
    ...
    paginated.forEach((item,index)=>{
        ...
        row.innerHTML = `
            ...
            <td>
                <a href="<?php echo e(url('dashboard/bookings')); ?>/${item.name}" class="btn btn-sm btn-primary">
                    View Detail
                </a>
            </td>
        `;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template.admin-dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\AdminTiketFerryLegend\resources\views/admin/admin-bookings.blade.php ENDPATH**/ ?>