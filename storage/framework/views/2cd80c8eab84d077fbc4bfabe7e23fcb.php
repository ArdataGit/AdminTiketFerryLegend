...
<div class="dashboard-welcome">
    ...
    <div class="welcome-banner p-4 p-md-5 mb-4 text-white rounded-4 shadow-lg position-relative overflow-hidden" 
        ...
        <div class="position-absolute top-0 end-0 h-100 w-50 d-none d-md-block" 
             style="background: url('<?php echo e(asset('img/bg/bg_1.png')); ?>') no-repeat center right; background-size: cover; opacity: 0.1; transform: scale(1.5);">
        </div>
        ...
        <div class="row align-items-center position-relative z-1">
            <div class="col-lg-8">
                <div class="d-inline-block px-3 py-1 bg-white bg-opacity-25 rounded-pill mb-3 animate__animated animate__fadeInDown">
                    <i class="fas fa-calendar-day me-2"></i> <?php echo e(date('l, d F Y')); ?>

                </div>
                
                <h1 class="display-5 fw-bold mb-3 animate__animated animate__fadeInLeft">
                    Selamat Datang, <?php echo e(Auth::user()->name ?? 'Admin Ferry Legend'); ?>! 👋
                </h1>
                ...
                <div class="d-flex flex-wrap gap-3 animate__animated animate__fadeInUp animate__delay-2s">
                    <a href="<?php echo e(route('bookings.index')); ?>" class="btn btn-light btn-lg px-4 fw-bold shadow-sm d-flex align-items-center gap-2 text-primary" style="border-radius: 12px;">
                        <i class="feather feather-book-open"></i> Kelola Pemesanan
                    </a>
                    <a href="<?php echo e(route('schedule.index')); ?>" class="btn btn-outline-light btn-lg px-4 fw-bold d-flex align-items-center gap-2" style="border-radius: 12px;">
        ...
        <div class="col-md-6 col-xl-3 animate__animated animate__fadeInUp animate__delay-1s">
            <div class="card h-100 border-0 shadow-sm rounded-4 hover-lift">
                <div class="card-body text-center p-4">
                    ...
                    <a href="<?php echo e(route('route.index')); ?>" class="btn btn-sm btn-outline-primary rounded-pill px-4">Buka Rute &rarr;</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-xl-3 animate__animated animate__fadeInUp animate__delay-2s">
            <div class="card h-100 border-0 shadow-sm rounded-4 hover-lift">
                <div class="card-body text-center p-4">
                    ...
                    <a href="<?php echo e(route('prices.index')); ?>" class="btn btn-sm btn-outline-success rounded-pill px-4">Buka Harga &rarr;</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-xl-3 animate__animated animate__fadeInUp animate__delay-3s">
            <div class="card h-100 border-0 shadow-sm rounded-4 hover-lift">
                <div class="card-body text-center p-4">
                    ...
                    <a href="<?php echo e(route('stops.index')); ?>" class="btn btn-sm btn-outline-warning rounded-pill px-4">Buka Dermaga &rarr;</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-xl-3 animate__animated animate__fadeInUp animate__delay-4s">
            <div class="card h-100 border-0 shadow-sm rounded-4 hover-lift">
                <div class="card-body text-center p-4">
                    ...
                    <a href="<?php echo e(route('settings.index')); ?>" class="btn btn-sm btn-outline-dark rounded-pill px-4">Buka Web Settings &rarr;</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('template.admin-dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\AdminTiketFerryLegend\resources\views/admin/dashboard/index.blade.php ENDPATH**/ ?>