...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Dashboard | Edurock - Education LMS Template'); ?></title>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/style.css')); ?>"><!-- Bootstrap CSS -->
...
<body class="body__wrapper">
    ...
    <div id="back__preloader">
        ...
        <div class="back__loader_logo">
            <img loading="lazy" src="<?php echo e(asset('img/pre.png')); ?>" alt="Preload">
        </div>
    </div>
        ...
        <header class="admin-header">
            <div class="logo">
                <a href="<?php echo e(url('/')); ?>">
                    <img loading="lazy" src="<?php echo e(asset('img/logo/logo_1.png')); ?>" 
                 class="logo-light" style="height: auto;width: 17rem;" alt="Edurock Logo">
            <img loading="lazy" src="<?php echo e(asset('img/logo/logo_2.png')); ?>" 
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="user-profile">
                    <img loading="lazy" src="<?php echo e(asset('img/user-placeholder.png')); ?>" alt="User">
                    <div class="dropdown">
                        <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown"><?php echo e(Auth::user()->name ?? 'Micle Obema'); ?></a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?php echo e(url('dashboard/admin-profile')); ?>">Profile</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(url('dashboard/admin-settings')); ?>">Settings</a></li>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-lg-3 col-md-12">
                            <div class="dashboard__inner sticky-top">
                                ...
                                <img loading="lazy" src="<?php echo e(asset('img/logo/logo_1.png')); ?>" alt="Edurock Logo">
                                </div> -->
                                <div class="dashboard__nav__title">
                                    <h6>Welcome, <?php echo e(Auth::user()->name ?? 'Micle Obema'); ?></h6>
                                </div>
                                <div class="dashboard__nav">
                                    <ul>
                                        <li style="list-style: none;">
                                            <a class="<?php echo e(($menu ?? '') === 'dashboard' ? 'active' : ''); ?> no-dot" href="<?php echo e(route('dashboard.index')); ?>">
                                        ...
                                        <li style="list-style: none;">
                                            <a class="<?php echo e(($menu ?? '') === 'vehicle-types' ? 'active' : ''); ?>" href="<?php echo e(url('/dashboard/vehicle-types')); ?>">
                                        ...
                                        <li style="list-style: none;">
                                            <a class="<?php echo e(($menu ?? '') === 'stops' ? 'active' : ''); ?>" href="<?php echo e(url('/dashboard/stops')); ?>">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" 
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" 
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round" 
                                        ...
                                        <li style="list-style: none;">
                                            <a class="<?php echo e(($menu ?? '') === 'routes' ? 'active' : ''); ?>" href="<?php echo e(url('/dashboard/routes')); ?>">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" 
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" 
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round" 
                                        ...
                                        <li style="list-style: none;">
                                            <a class="<?php echo e(($menu ?? '') === 'prices' ? 'active' : ''); ?>" href="<?php echo e(url('/dashboard/prices')); ?>">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" 
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" 
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round" 
                                        ...
                                        <li style="list-style: none;">
                                            <a class="<?php echo e(($menu ?? '') === 'schedule' ? 'active' : ''); ?>" href="<?php echo e(url('/dashboard/schedule')); ?>">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" 
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" 
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round" 
                                        ...
                                        <li style="list-style: none;">
                                            <a class="<?php echo e(($menu ?? '') === 'channel-quota' ? 'active' : ''); ?>" href="<?php echo e(url('/dashboard/channel-quota')); ?>">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" 
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" 
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round" 
                                        ...
                                        <li style="list-style: none;">
                                            <a class="<?php echo e(($menu ?? '') === 'bookings' ? 'active' : ''); ?>" href="<?php echo e(url('/dashboard/bookings')); ?>">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" 
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" 
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round" 
                                        ...
                                        <li style="list-style: none;">
                                            <a class="<?php echo e(($menu ?? '') === 'Transaction' ? 'active' : ''); ?>" href="<?php echo e(url('/dashboard/transaction')); ?>">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" 
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" 
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round" 
                                                    class="feather feather-book-open">
...
</html><?php /**PATH C:\laragon\www\AdminTiketFerryLegend\resources\views/template/admin-dashboard.blade.php ENDPATH**/ ?>